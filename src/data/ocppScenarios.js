    ...
    steps: [
      {
        ...
        payload: { connectorId: 1, idTag: "TEST1234" }, log: "RemoteStartTransaction "
      },
      {
        action: "StartTransaction",
        payload: { connectorId: 1, idTag: "TEST1234", meterStart: 100, timestamp: new Date().toISOString() },
      ...
      { action: "RemoteStopTransaction", payload: { connectorId: 1, idTag: "TEST1234", }, log: "RemoteStopTransaction Transaction" },

      // // STEP 4: Stop Transaction
      {
        action: "StopTransaction",
        payload: { connectorId: 1, meterStop: 200, idTag: "TEST1234", timestamp: new Date().toISOString() }, log: "Stop Transaction"
      },
    ]
  }
